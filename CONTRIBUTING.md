...
```bash
git clone git@github.com:ghostwriter/phpunit-assertions.git
cd phpunit-assertions
git remote add upstream git://github.com/ghostwriter/phpunit-assertions.git
```
